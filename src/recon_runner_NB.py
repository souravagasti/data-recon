...
if __name__ == "__main__":
    ...
    recon = run_recon_notebook(
        ...
        source1_settings="mnt/adls/recon-project/tax-recon/input/settings1.json",
        source2_settings="mnt/adls/recon-project/tax-recon/input/settings2.json",
        recon_type="pk_cleansed",
        path_name="/mnt/adls/recon-project/tax-recon"
    )
